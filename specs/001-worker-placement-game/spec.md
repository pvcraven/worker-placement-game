...
- Q: What are the starting board locations? → A: 7 basic permanent locations (The Merch Store: 2 Coins; Motown: 2 Bass Players; Guitar Center: 2 Guitarists; Talent Show: 2 Singers; The Rhythm Pit: 2 Drummers; Cliffwatch Inn: 3 action spots for contracts/intrigue cards; Builder's Hall: buy buildings), plus Castle Waterdeep (gain first-player marker + 1 intrigue card), plus The Garage (3 intrigue card slots with reassignment).
...
- Q: What standard attributes should buildings, quests, and intrigue cards have? → A: All three content types share a common attribute structure: (1) unique ID, (2) name, (3) descriptive text, (4) cost to play/use, (5) immediate benefit on completion/use, (6) ongoing benefit if applicable. Contract (quest) cards additionally have a genre type (Jazz, Pop, Soul, Funk, Rock).
...
- **FR-027**: Configuration files MUST define the following attributes for all content types (buildings, contract cards, intrigue cards): (1) unique ID, (2) name, (3) descriptive text, (4) cost to play or use (resources and/or Coins), (5) immediate benefit on completion/use (Victory Points, resources, Coins, or special effects), (6) ongoing benefit if applicable. Contract cards MUST additionally include a genre type (Jazz, Pop, Soul, Funk, or Rock).
...
- **FR-029**: The game board MUST include the following permanent action spaces: The Merch Store (gain 2 Coins), Motown (gain 2 Bass Players), Guitar Center (gain 2 Guitarists), Talent Show (gain 2 Singers), The Rhythm Pit (gain 2 Drummers), Cliffwatch Inn (3 distinct action spots for acquiring contracts or intrigue cards), and Builder's Hall (purchase building tiles).
...
- **Contract Card** (Quest): Represents a band to assemble. Attributes: unique ID, name, descriptive text, cost (required musicians), immediate benefit (Victory Points and/or bonus resources), ongoing benefit (for Plot Contracts), and genre type (Jazz, Pop, Soul, Funk, or Rock). 60 total cards in the deck: 34 easier (≤9 VP) and 26 harder (≥10 VP). A subset are Plot Contracts that remain in play after completion, providing permanent ongoing benefits (deferred to later phase but supported in data model).
- **Building Tile**: A purchasable tile themed as a famous recording studio or music venue (e.g., "First Avenue", "Abbey Road Studios", "The Troubadour"). Attributes: unique ID, name, descriptive text, cost (Coins to purchase), immediate benefit (reward when any player uses it), ongoing benefit (owner bonus when another player uses it). Creates a new action space when placed on an empty lot. 24 tiles in the game.
- **Intrigue Card**: A music-industry-themed card with a tactical effect, played at The Garage action space. Attributes: unique ID, name, descriptive text, cost (none — played for free at The Garage), immediate benefit (effect on self or target player), ongoing benefit (if applicable). 50 total cards. Examples: "Private Plane" (gain resources), "We Are The World Concert" (multi-player event), "Extra Recording Time" (bonus resources), "Award Shows" (VP bonus), "Roadies Go On Strike" (opponent loses resources). No mandatory quest mechanic.
...
- **Game Board**: The shared play area containing all permanent action spaces (The Merch Store, Motown, Guitar Center, Talent Show, The Rhythm Pit, Cliffwatch Inn, Builder's Hall, Castle Waterdeep, Garage), building lots for constructed venues, contract display, and player status displays.
